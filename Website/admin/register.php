...
<head>
    ...
    <title>Go-pals Admin Register Page</title>
		...
		<div class="container-fluid vcenter" >
			<div class="row">
				...
				<div class="col-md-4 col-sm-6 col-xs-8 loginform" >
					<h2 style="text-align:center;">Register Panel</h2></br></br>
					<form role="form" action="" method="POST">
						...
						<div class="col-md-12 text-center"> 
							<button type="submit" class="btn btn-primary btn-sub" style="margin-bottom:20px; width:80%;">Register</button>
						</div>
					</form>
					<?php
					include ("config.php");
